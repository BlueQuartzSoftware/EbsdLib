...
public:
  ...
  Quaternion(const Quaternion&) = default;            // Copy Constructor Not Implemented
  Quaternion(Quaternion&&) = default;                 // Move Constructor Not Implemented
  Quaternion& operator=(const Quaternion&) = default; // Copy Assignment Not Implemented
  Quaternion& operator=(Quaternion&&) = default;      // Move Assignment Not Implemented
