...
{
  std::string outputPath = ebsdlib::unit_test::k_TestTempDir + "TiffWriterTest_RGB.tif";
...
{
  std::string outputPath = ebsdlib::unit_test::k_TestTempDir + "TiffWriterTest_RGBA.tif";
...
{
  std::string outputPath = ebsdlib::unit_test::k_TestTempDir + "TiffWriterTest_Gray.tif";
